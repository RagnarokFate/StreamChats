...
import { CommandEvent, StatusUpdateEvent } from '@obs-chat/event-schema';
...
export function Dashboard({ sendCommand, messages, statusUpdate }: DashboardProps) {
    ...
    <div className="dashboard-container" style={{ 
      ...
      <nav className="dashboard-sidebar" style={{ 
        ...
        <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <li><Link to="/dashboard/overlay" style={linkStyle(pathname === '/dashboard/overlay')}>🎨 Overlay Settings</Link></li>
      ...
      <main className="dashboard-content" style={{ flex: 1, padding: '32px', overflowY: 'auto' }}>
        <Routes>
          ...
          <Route path="overlay" element={<OverlaySettings sendCommand={sendCommand} />} />
